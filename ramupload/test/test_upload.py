...
def test_rsync(uploader, img_path, dest_path):
    ...
    print(dest_path, osp.exists(dest_path))
...
def test_upload_clinical_eeg(uploader, img_path, dest_path):
    ...
    # uploader.upload_clinical_eeg(img_path, dest_path)
